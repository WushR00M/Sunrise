/// @description Values
	character = CHAR_DASH;		//Character variable
	...
	//Physics values
	x_accel = 0.6;					//Value used for player's horizontal acceleration
	y_accel = 0.21875;					//Value used for player's vertical acceleration, specifically gravirt
	friction_speed = 0.5;			//Value used for player's friction when input is not being held
	top_speed = 7;						//Value used for player's top running speed
