...
draw_set_color(c_white);
draw_text(desc_x, room_height - 64, description_text);

draw_set_halign(fa_right);
draw_text(room_width - 32, 32, "Small Notice: Most options in these Settings are currently in the works and won't do anything yet!");