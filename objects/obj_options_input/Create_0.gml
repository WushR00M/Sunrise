...
menu_top = 64;
	...
	array_push(options, make_toggle("Tablet Mode", "", false));
	array_push(options, make_toggle("Raw Input", "", false));
	array_push(options, make_toggle("Always Use Virtual Keyboard", "", false));

	array_push(options, { type: "header", name: "Controller Use" });
	array_push(options, make_toggle("Haptics", "", true));
	array_push(options, make_toggle("In-Game Button Guide", "", true));
	array_push(options, make_toggle("Custom Light Bar Color", "", false));
	array_push(options, make_toggle("Switch ACCEPT and CANCEL Mappings", "", false));
	array_push(options, make_button("Calibrate Controller", "", function() {}));
