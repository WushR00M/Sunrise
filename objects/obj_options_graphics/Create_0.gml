...
menu_top = 64;
	...
	array_push(options, make_toggle("Colorblind Icons", "", false));
	array_push(options, make_toggle("Title Screen Snow", "", true));
	array_push(options, make_toggle("Menu Parallax Effects", "", true));
