...
menu_top = 64;
	...
	array_push(options, { type: "header", name: "Cosmetic" });
	array_push(options, make_toggle("Show HUD", "", true));
	array_push(options, make_toggle("Progress Display", "", true));
	array_push(options, make_toggle("Skip Title Cards", "", false));
	array_push(options, make_toggle("Always Show Key Strokes", "", true));
	array_push(options, make_toggle("Level Background Dimming", "", false));
	array_push(options, make_toggle("Show Leaderboard during Gameplay", "", false));
	
	array_push(options, { type: "header", name: "Difficulty" });
	array_push(options, make_toggle("Casual Mode", "", false));
	
	array_push(options, { type: "header", name: "Debugging" });
	array_push(options, make_toggle("Show Collision Tags", "", false));
	array_push(options, make_toggle("Show Path Finders", "", false));
	array_push(options, make_toggle("Show Debug HUD", "", false));
